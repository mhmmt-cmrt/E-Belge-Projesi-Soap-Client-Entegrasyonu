...
from com.izibiz.despatch_advice import RequestHeadertype, SendDespatchAdviceRequest, SendReceiptAdviceRequest, \
    ...
    EirsaliyeServicePortSendDespatchAdviceInput, LoadDespatchAdviceRequest,\
...
class DespatchAdviceActions:
    ...
    def get_despatch_advice_with_status(self):
        """Entegrasyon platformunda bulunan bir veya birden fazla taslak, gelen ve
           giden irsaliyenin durumunu sorgulamayı sağlayan servistir."""
    ...
    def send_despatch_response(self):
        """irsaliye cevabı olusturmak icin kulanılan servistir.
           7 gunluk cevap verme suresine dikkat edilerek islem yapilmalidir."""
        request_header_type = RequestHeadertype()
        request_header_type.session_id = self.session_id
        request_header_type.compressed = "Y"
        ...
        despatchadvice = Despatchadvice()
        despatchadvice.id = "MUH2023000041774"
        despatchadvice.uuid = "e5098667-4bea-4a71-aac6-5209b3a87d21"
        ...
        self.tools.display_response_body(sendDespatchResponseResponse)
